...
-- ==========================================
local Settings = {
    SilentAimEnabled = true, -- Tự bẻ skill/tấn công mà không xoay camera
    FOVRadius = 150,
    FOVVisible = true,
    TracerEnabled = true,
    ESPEnabled = true,
...
-- ==========================================
-- VẼ VÒNG FOV CỐ ĐỊNH Ở TÂM MÀN HÌNH
-- ==========================================
...
-- Đường kẻ Aim (Tracer Line) từ tâm màn hình tới mục tiêu
...
-- ==========================================
-- TÌM KẺ ĐỊCH GẦN TÂM MÀN HÌNH NHẤT
-- ==========================================
...
-- ==========================================
-- SILENT AIM HOOK (ÉP SKILL VÀO ĐỐI THỦ)
-- ==========================================
local oldIndex
oldIndex = hookmetamethod(game, "__index", function(self, key)
    if not checkcaller() and Settings.SilentAimEnabled and self == Mouse then
...
Title.Text = "   🔥 SILENT SKILL AIM HUB"
...
-- ==========================================
-- CÀI ĐẶT CÁC MỤC TRONG MENU
-- ==========================================
CreateSection("SKILL & AIM")
CreateToggle("Silent Skill Aim (Tự Trúng Skill)", Settings.SilentAimEnabled, function(s) Settings.SilentAimEnabled = s end)
CreateToggle("Đường Kẻ Aim (Tracer Line)", Settings.TracerEnabled, function(s) Settings.TracerEnabled = s end)
CreateToggle("Hiện FOV Ở Tâm Màn Hình", Settings.FOVVisible, function(s) Settings.FOVVisible = s end)
CreateInput("Bán kính FOV Radius", Settings.FOVRadius, function(v) Settings.FOVRadius = v end)

CreateSection("VISUALS")
CreateToggle("Bật ESP Khung & Tên", Settings.ESPEnabled, function(s) Settings.ESPEnabled = s end)
...
RunService.RenderStepped:Connect(function()
    ...
    -- Cập nhật Vòng FOV ở chính giữa màn hình
    FOVCircle.Position = screenCenter
    FOVCircle.Radius = Settings.FOVRadius
    FOVCircle.Visible = Settings.FOVVisible

    -- Tìm kẻ địch gần nhất trong vòng FOV cố định
    local target = GetClosestPlayerInFOV()

    -- Xử lý đường kẻ Tracer kết nối từ tâm màn hình đến target
    if target and target.Character and target.Character:FindFirstChild("HumanoidRootPart") then
