...
--// FULL MOBILE VERSION
--// Graphics Reduction + Toggle + Water/Fog/Rain Removal
--// Responsive UI + Draggable Floating Logo
--//========================================================
...
local function UpdateScale()
    ...
    local BaseWidth = 360
    local BaseHeight = 455

    local ScaleX = (Viewport.X - 20) / BaseWidth
    local ScaleY = (Viewport.Y - 20) / BaseHeight

    local Scale = math.min(ScaleX, ScaleY)

    -- Không cho menu quá nhỏ
...
Main.Position = UDim2.new(0.5, -180, 0.5, -227)
...
local function CreateLogo(Parent, Size, Position)
    ...
    -- Nếu asset ID không load được thì thử thumbnail
...
SocialTitle.Position = UDim2.fromOffset(16, 72)
...
PercentTitle.Position = UDim2.fromOffset(16, 196)
...
PercentBox.Position = UDim2.fromOffset(16, 220)
...
PercentInfo.Position = UDim2.fromOffset(121, 220)
...
SettingsTitle.Position = UDim2.fromOffset(16, 258)
...
CreateToggle(
    "Particles / Effects",
    "Particles",
    UDim2.fromOffset(182, 282)
)

CreateToggle(
    "Lights",
    "Lights",
    UDim2.fromOffset(16, 314)
)

CreateToggle(
    "Textures / Decals",
    "Textures",
    UDim2.fromOffset(182, 314)
)

CreateToggle(
    "Post Effects",
    "PostEffects",
    UDim2.fromOffset(16, 346)
)

CreateToggle(
    "Atmosphere / Fog",
    "Atmosphere",
    UDim2.fromOffset(182, 346)
)

CreateToggle(
    "Terrain / Water",
    "Terrain",
    UDim2.fromOffset(16, 378)
)

CreateToggle(
    "Low Material",
    "LowMaterial",
    UDim2.fromOffset(182, 378)
)

CreateToggle(
    "Xóa mặt biển",
    "RemoveWater",
    UDim2.fromOffset(16, 410)
)

CreateToggle(
    "Xóa mưa",
    "RemoveRain",
    UDim2.fromOffset(182, 410)
)
...
Status.Position = UDim2.fromOffset(16, 442)
...
FixButton.Position = UDim2.fromOffset(16, 463)
