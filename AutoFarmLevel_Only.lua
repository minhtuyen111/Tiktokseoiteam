local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/PlockScripts/Library-ui/refs/heads/main/redz-V5-remake/main.luau"))()
local Window = Library:MakeWindow({
    Title = "RedzHub | Auto Farm Level",
    SubTitle = "Blox Fruits",
    SaveFolder = "RedzHub_AutoFarmLevel"
})
local FarmTab = Window:MakeTab({"Auto Farm Level", "home"})
...
function EquipWeapon(name)
    ...
    if not _G.NotAutoEquip and LocalPlayer.Backpack:FindFirstChild(name) then
        ...
        pcall(function()
            if _G.SelectWeapon == "Melee" then
                for _, tool in pairs(LocalPlayer.Backpack:GetChildren()) do
                    if tool.ToolTip == "Melee" then _G.SelectWeapon = tool.Name end
                end
            elseif _G.SelectWeapon == "Sword" then
                for _, tool in pairs(LocalPlayer.Backpack:GetChildren()) do
                    if tool.ToolTip == "Sword" then _G.SelectWeapon = tool.Name end
                end
            elseif _G.SelectWeapon == "Gun" then
                for _, tool in pairs(LocalPlayer.Backpack:GetChildren()) do
                    if tool.ToolTip == "Gun" then _G.SelectWeapon = tool.Name end
                end
            elseif _G.SelectWeapon == "Fruit" or _G.SelectWeapon == "Blox Fruit" then
                for _, tool in pairs(LocalPlayer.Backpack:GetChildren()) do
                    if tool.ToolTip == "Blox Fruit" then _G.SelectWeapon = tool.Name end
                end
            end
        end)
    end
